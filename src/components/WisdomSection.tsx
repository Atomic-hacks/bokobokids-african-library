  ...
  const cards = [
    {
      ...
      description:
        "Nurturing emotional intelligence and self-awareness through African wisdom traditions",
      color: "bg-wisdom",
        ...
        >
          ...
          >
            {cards.map((card, index) => (
              ...
              >
                <div
                  className={`${card.color} rounded-3xl p-8 h-full shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden`}
                >
                  {/* Background Pattern */}
                  ...
                  <div className="relative z-10">
                    ...
                    <h4
                      className={`text-2xl font-bold font-fredoka mb-4 ${card.iconColor}`}
                    >
                      {card.title}
                    </h4>

                    <p
                      className={`font-baloo leading-relaxed ${card.iconColor}/90`}
                    >
                      {card.description}
                    </p>
                  </div>
