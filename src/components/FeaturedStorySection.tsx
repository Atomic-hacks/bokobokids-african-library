      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            {/* Book Image */}
            <motion.div variants={bookVariants} className="relative group">
              <motion.div
                whileHover={{
                  scale: 1.05,
                  rotateY: 5,
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <motion.div variants={itemVariants} className="space-y-4">
                <p className="text-lg text-muted-foreground font-baloo leading-relaxed">
                  Journey through ancient Nubian kingdoms where children
                  discover the power of their heritage and identity. This
                  captivating tale weaves together history, culture, and
                  adventure in a story that speaks to young hearts.
                </p>

                <p className="text-lg text-muted-foreground font-baloo leading-relaxed">
                  Perfect for children aged 8-12, this beautifully illustrated
                  book helps young readers understand their place in the world
                  while celebrating the rich tapestry of African culture and
                  wisdom.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 py-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-foreground font-baloo">
                      Cultural Identity
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              >
                <blockquote className="text-card-foreground font-baloo italic text-lg leading-relaxed">
                  "Every child deserves to see themselves reflected in the
                  stories they read, to understand their heritage, and to dream
